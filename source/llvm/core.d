...
mixin(joinFnBinds((){
	FnBind[] ret = [
		...
		{q{uint}, q{LLVMGetLastEnumAttributeKind}, q{void}},
		...
		{q{void}, q{LLVMSetModuleInlineAsm2}, q{LLVMModuleRef m, const(char)* asm, size_t len}},
		{q{void}, q{LLVMAppendModuleInlineAsm}, q{LLVMModuleRef m, const(char)* asm, size_t len}},
		...
		{q{void}, q{LLVMSetModuleInlineAsm}, q{LLVMModuleRef m, const(char)* asm}},
		...
		{q{LLVMValueRef}, q{LLVMConstInt}, q{LLVMTypeRef intTy, uint long long n, LLVMBool signExtend}},
		...
		{q{void}, q{LLVMSetDLLStorageClass}, q{LLVMValueRef global, LLVMDLLStorageClass class}},
		...
		{q{LLVMValueRef}, q{LLVMAliasGetAliasee}, q{LLVMValueRef alias}},
		{q{void}, q{LLVMAliasSetAliasee}, q{LLVMValueRef alias, LLVMValueRef aliasee}},
		...
		{q{void}, q{LLVMSetParamAlignment}, q{LLVMValueRef arg, uint align}},
		...
		{q{void}, q{LLVMSetInstrParamAlignment}, q{LLVMValueRef instr, LLVMAttributeIndex idx, uint align}},
		...
		{q{LLVMBuilderRef}, q{LLVMCreateBuilder}, q{void}},
		...
		{q{LLVMValueRef}, q{LLVMBuildCondBr}, q{LLVMBuilderRef, LLVMValueRef if, LLVMBasicBlockRef then, LLVMBasicBlockRef else}},
		{q{LLVMValueRef}, q{LLVMBuildSwitch}, q{LLVMBuilderRef, LLVMValueRef v, LLVMBasicBlockRef else, uint numCases}},
		{q{LLVMValueRef}, q{LLVMBuildIndirectBr}, q{LLVMBuilderRef b, LLVMValueRef addr, uint numDests}},
		{q{LLVMValueRef}, q{LLVMBuildInvoke2}, q{LLVMBuilderRef, LLVMTypeRef ty, LLVMValueRef fn, LLVMValueRef* args, uint numArgs, LLVMBasicBlockRef then, LLVMBasicBlockRef catch, const(char)* name}},
		...
		{q{void}, q{LLVMAddCase}, q{LLVMValueRef switch, LLVMValueRef onVal, LLVMBasicBlockRef dest}},
		...
		{q{LLVMValueRef}, q{LLVMBuildMemSet}, q{LLVMBuilderRef b, LLVMValueRef ptr, LLVMValueRef val, LLVMValueRef len, uint align}},
		...
		{q{LLVMValueRef}, q{LLVMBuildSelect}, q{LLVMBuilderRef, LLVMValueRef if, LLVMValueRef then, LLVMValueRef else, const(char)* name}},
		...
		{q{LLVMValueRef}, q{LLVMBuildAtomicCmpXchg}, q{LLVMBuilderRef b, LLVMValueRef ptr, LLVMValueRef cmp, LLVMValueRef new, LLVMAtomicOrdering successOrdering, LLVMAtomicOrdering failureOrdering, LLVMBool singleThread}},
